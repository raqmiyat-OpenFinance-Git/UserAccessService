...
{
    public class InwardBatchPaymentReturnReport
    {
        public List<InwardBatchPaymentTransferSummary>? inwardBatchPaymentTransferSummary { get; set; }
        ...
        public List<InwardBatchPaymentTransferDetail>? inwardBatchPaymentTransferDetail { get; set; }
    }
    public class InwardBatchPaymentTransferDetail
    {
    ...
    public class InwardBatchPaymentTransferSummary
    {
        public string? Return_RefNbr { get; set; }
        public string? Original_RefNbr { get; set; }
