...
{
    public class OutwardBatchCreditTransferReport
    {
        public List<OutwardBatchCreditTransferSummary>? OutwardBatchCredit_TransferSummary { get; set; }
        ...
        public List<OutwardBatchCreditTransferDetail>? outwardBatchCreditTransferDetail { get; set; }
    }
    public class OutwardBatchCreditTransferDetail
    {
    ...
    public class OutwardBatchCreditTransferSummary
    {
        public string? Creation_Date { get; set; }
        public string? Ref_No { get; set; }
